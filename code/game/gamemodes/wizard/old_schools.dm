// A long time ago, magic schools were used as a unusual mechanic
// for wizard apprentices, but due to game balance problems,
// they has been deleted. Now here slumber everething, that has
// left from them.
...
/obj/item/magicschool_contract/attack_self(mob/user)
	ui_interact(user)

/obj/item/magicschool_contract/ui_state(mob/user)
	return GLOB.inventory_state

/obj/item/magicschool_contract/ui_interact(mob/user, datum/tgui/ui)
	ui = SStgui.try_update_ui(user, src, ui)
	if(!ui)
		ui = new(user, src, "ApprenticeContract", name)
		ui.open()

/obj/item/magicschool_contract/ui_data(mob/user)
	var/list/data = list()
	data["isUsed"] = used
	data["isBook"] = istype(src, /obj/item/magicschool_contract/apprentice_choose_book)
...
/obj/item/magicschool_contract/apprentice
	name = "apprentice contract"
	desc = "A magic contract previously signed by an apprentice. In exchange for instruction in the magical arts, they are bound to answer your call for aid."

/obj/item/magicschool_contract/apprentice/ui_act(action, list/params, datum/tgui/ui, datum/ui_state/state)
	. = ..()
	if(.)
		return
...
/obj/item/magicschool_contract/apprentice/proc/handle_choose_school(mob/living/carbon/human/teacher, school_id)
	if(used)
...
/obj/item/magicschool_contract/apprentice_choose_book
...
/obj/item/magicschool_contract/apprentice_choose_book/infinity_book
...
/obj/item/magicschool_contract/apprentice_choose_book/ui_act(action, list/params, datum/tgui/ui, datum/ui_state/state)
	. = ..()
	if(.)
		return
...
/obj/item/magicschool_contract/proc/school_href_choose(href_list, mob/living/carbon/human/teacher, mob/living/carbon/human/apprentice)
